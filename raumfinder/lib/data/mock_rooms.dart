...
final List<Room> mockRooms = [
  Room(
    ...
    coordinates: Coordinates(
      latitude: 53.83424510447914,
      longitude: 10.700101839618801,
    ),
    bookings: [
      //Ferien
      Occupation(
        date: DateTime(2025, 12, 24, 10, 15),
        duration: Duration(minutes: 90),
        eventName: "Biologie für Mediziner / MED1-10031Bio / Vorlesung",
        instructor: "Hartmann",
      ),
      Occupation(
        date: DateTime(2025, 12, 24, 18, 00),
        duration: Duration(hours: 4),
        eventName: "Proben der Lübeck Popsymphonics",
        instructor: "Zemke",
      ),
      Occupation(
        date: DateTime(2025, 12, 31, 10, 15),
        duration: Duration(minutes: 90),
        eventName: "Biologie für Mediziner / MED1-10031Bio / Vorlesung",
        instructor: "Hartmann",
      ),
      Occupation(
        date: DateTime(2025, 12, 31, 18, 00),
        duration: Duration(hours: 4),
        eventName: "Proben der Lübeck Popsymphonics",
        instructor: "Zemke",
      ),
      ...
      // Montag, 05.01.2026
      Occupation(
        date: DateTime(2026, 1, 5, 10, 00),
        duration: Duration(hours: 2),
        eventName: "EinfProg V Theorie",
        instructor: "Fischer",
      ),
      Occupation(
        date: DateTime(2026, 1, 5, 12, 00),
        duration: Duration(hours: 2),
        eventName: "Signal VL",
        instructor: "Droigk",
      ),
      Occupation(
        date: DateTime(2026, 1, 5, 14, 00),
        duration: Duration(hours: 2),
        eventName: "LADS 1 V",
      ...
      // Dienstag, 06.01.2026
      Occupation(
        date: DateTime(2026, 1, 6, 9, 00),
        duration: Duration(hours: 1),
        eventName: "AC Medizin / AC V",
        instructor: "Weimar",
      ),
      Occupation(
        date: DateTime(2026, 1, 6, 10, 00),
        duration: Duration(hours: 2),
        eventName: "Ana1KP08, Ana1KP09 V",
        instructor: "Prestin",
      ),
      Occupation(
        date: DateTime(2026, 1, 6, 12, 00),
        duration: Duration(hours: 2),
        eventName: "MBG",
        instructor: "Koch",
      ),
      Occupation(
        date: DateTime(2026, 1, 6, 14, 00),
        duration: Duration(hours: 2),
      ...
      // Mittwoch, 07.01.2026
      Occupation(
        date: DateTime(2026, 1, 7, 8, 00),
        duration: Duration(hours: 2),
        eventName: "EMedTec",
        instructor: "Gräfe",
      ),
      Occupation(
        date: DateTime(2026, 1, 7, 10, 15),
        duration: Duration(minutes: 90),
        eventName: "Bio1KP08 / Biologie für Mediziner",
        instructor: "Hartmann",
      ),
      Occupation(
        date: DateTime(2026, 1, 7, 12, 00),
        duration: Duration(hours: 2),
        eventName: "KogPsy",
        instructor: "Franke",
      ),
      Occupation(
        date: DateTime(2026, 1, 7, 16, 00),
        duration: Duration(hours: 2),
        eventName: "BioMaKP05; Biomathe V",
        instructor: "Bey",
      ),
      Occupation(
        date: DateTime(2026, 1, 7, 18, 00),
        duration: Duration(hours: 4),
        eventName: "Proben der Lübeck Popsymphonics",
        instructor: "Zemke",
      ),
      ...
      Occupation(
        date: DateTime(2026, 1, 8, 8, 00),
        duration: Duration(hours: 1),
        eventName: "AC Übungen",
        instructor: "Weimar",
      ),
      Occupation(
        date: DateTime(2026, 1, 8, 10, 15),
        duration: Duration(minutes: 90),
        eventName: "Bio1KP08 / Biologie für Mediziner",
        instructor: "Hartmann",
      ),
      Occupation(
        date: DateTime(2026, 1, 8, 12, 00),
        duration: Duration(hours: 2),
        eventName: "PY2601 Grundlagen der Medizin",
        instructor: "Paulus",
      ),
      Occupation(
        date: DateTime(2026, 1, 8, 14, 00),
        duration: Duration(hours: 2),
        eventName: "LADS 1 V",
        instructor: "Modersitzki",
      ),
      ...
      // Freitag, 09.01.2026
      Occupation(
        date: DateTime(2026, 1, 9, 8, 00),
        duration: Duration(hours: 2),
        eventName: "Ana1KP08, Ana1KP09 V",
        instructor: "Prestin",
      ),
      Occupation(
        date: DateTime(2026, 1, 9, 8, 30),
        duration: Duration(minutes: 90),
        eventName: "ETechnik1(V)",
        instructor: "Rostalski",
      ),
      Occupation(
        date: DateTime(2026, 1, 9, 10, 00),
        duration: Duration(hours: 2),
        eventName: "AC Medizin / AC V",
        instructor: "Weimar",
      ),
      Occupation(
        date: DateTime(2026, 1, 9, 13, 00),
        duration: Duration(hours: 1),
        eventName: "Seminarklausur für Mediziner",
        instructor: "Kusche",
      ),
      Occupation(
        ...
        instructor: "Zemke",
      ), // Ab 14:00 bis Mitternacht
      Occupation(
        date: DateTime(2026, 1, 9, 14, 15),
        duration: Duration(minutes: 90),
        eventName: "ETechnik1 (UE)",
        instructor: "Rostalski",
      ),

      // Samstag, 10.01.2026
      Occupation(
        date: DateTime(2026, 1, 10, 7, 00),
  ...
  Room(
    ...
    coordinates: Coordinates(
      latitude: 53.83786642290044,
      longitude: 10.70848161620306,
    ),
    bookings: [
      // Montag, 05.01.2026
      Occupation(
        date: DateTime(2026, 1, 5, 8, 00),
        duration: Duration(hours: 2),
        eventName:
      ...
      Occupation(
        date: DateTime(2026, 1, 5, 12, 00),
        duration: Duration(minutes: 90),
        eventName: "Allge Viro V / Zellbio MV V / 1. Exam General Virology",
        instructor: "Tautz / Isken",
      ),

      // Dienstag, 06.01.2026
      Occupation(
        date: DateTime(2026, 1, 6, 8, 00),
        duration: Duration(hours: 2),
        eventName: "Physio",
        instructor: "Oster",
      ),
  ...
  Room(
    ...
    bookings: [
      //Ferien
      Occupation(
        date: DateTime(2025, 12, 22, 7, 00),
        duration: Duration(hours: 1),
        eventName: "Montagsfortbildung",
        instructor: "Zemke",
      ),
      Occupation(
        date: DateTime(2025, 12, 22, 7, 00),
      ...
      Occupation(
        date: DateTime(2026, 1, 6, 15, 00),
        duration: Duration(hours: 1),
        eventName: "Vorles. Chirurgie",
        instructor: "Keck",
      ),
      Occupation(
        date: DateTime(2026, 1, 6, 16, 00),
        duration: Duration(hours: 2),
      ...
      // Mittwoch, 07.01.2026
      Occupation(
        date: DateTime(2026, 1, 7, 08, 00),
        duration: Duration(hours: 2),
        eventName: "PF1100-Skills",
        instructor: "N.N.",
      ),
      Occupation(
        date: DateTime(2026, 1, 7, 10, 15),
      ...
      Occupation(
        date: DateTime(2026, 1, 7, 15, 00),
        duration: Duration(hours: 2),
        eventName: "Hauptvorlesung Pädiatrie",
        instructor: "Hiort",
      ),
      Occupation(
        date: DateTime(2026, 1, 7, 17, 00),
        duration: Duration(hours: 1),
        eventName: "Hauptvorlesung Innere Medizin",
        instructor: "Marquardt",
      ),
      ...
      Occupation(
        date: DateTime(2026, 1, 9, 15, 00),
        duration: Duration(hours: 1),
        eventName: "Anaesthesie",
        instructor: "Nau",
      ),
      Occupation(
        date: DateTime(2026, 1, 9, 16, 00),
        duration: Duration(hours: 1),
  ...
  Room(
    ...
    bookings: [
      //Ferien
      Occupation(
        date: DateTime(2025, 12, 22, 18, 00),
        duration: Duration(hours: 6),
        eventName: "Fachschaftssitzungen",
        instructor: "Köhl",
      ),
      Occupation(
        date: DateTime(2025, 12, 23, 18, 00),
        duration: Duration(hours: 6),
        eventName: "Fachschaftssitzungen",
        instructor: "Köhl",
      ),
      ...
      Occupation(
        date: DateTime(2025, 12, 25, 18, 00),
        duration: Duration(hours: 6),
        eventName: "Fachschaftssitzungen",
        instructor: "Köhl",
      ),
      Occupation(
        date: DateTime(2025, 12, 29, 18, 00),
        duration: Duration(hours: 6),
        eventName: "Fachschaftssitzungen",
        instructor: "Köhl",
      ),
      Occupation(
        date: DateTime(2025, 12, 30, 18, 00),
        duration: Duration(hours: 6),
        eventName: "Fachschaftssitzungen",
        instructor: "Köhl",
      ),
      ...
      Occupation(
        date: DateTime(2025, 01, 01, 18, 00),
        duration: Duration(hours: 6),
        eventName: "Fachschaftssitzungen",
        instructor: "Köhl",
      ),
      ...
      // Montag, 05.01.2026
      Occupation(
        date: DateTime(2026, 1, 5, 08, 30),
        duration: Duration(minutes: 90),
        eventName: "Prakt. Übg. Physiologie",
        instructor: "Kusche",
      ),
      Occupation(
        date: DateTime(2026, 1, 5, 18, 00),
        duration: Duration(hours: 6),
      ...
      Occupation(
        date: DateTime(2026, 1, 6, 13, 00),
        duration: Duration(hours: 1),
        eventName: "SWEng Ü",
        instructor: "Wolter",
      ),
      Occupation(
        date: DateTime(2026, 1, 6, 14, 15),
        duration: Duration(minutes: 90),
        eventName: "Evi3",
        instructor: "N.N.",
      ),
      Occupation(
        date: DateTime(2026, 1, 6, 18, 00),
        duration: Duration(hours: 5),
        eventName: "Sitzung der FS Psy",
        instructor: "Köhl",
      ),

      // Mittwoch, 07.01.2026
      Occupation(
        date: DateTime(2026, 1, 7, 08, 30),
        duration: Duration(minutes: 90),
        eventName: "Prakt. Übg. Physiologie",
        instructor: "Kusche",
      ),
      ...
      Occupation(
        date: DateTime(2026, 1, 8, 18, 00),
        duration: Duration(hours: 5),
        eventName: "Sitzung der FS MuG",
        instructor: "Köhl",
      ),

      // Freitag, 09.01.2026
      Occupation(
        date: DateTime(2026, 1, 9, 09, 00),
        duration: Duration(hours: 2),
        eventName: "MDS V",
        instructor: "Grzegorzek",
      ),
      Occupation(
        date: DateTime(2026, 1, 9, 11, 00),
  ...
  Room(
    ...
    bookings: [
      ...
      Occupation(
        date: DateTime(2026, 1, 5, 10, 15),
        duration: Duration(minutes: 90),
        eventName: "Gesundheitsökonomie und Qualitätsmanagement / Seminar",
        instructor: "Elsner",
      ),
      Occupation(
        date: DateTime(2026, 1, 5, 18, 00),
      ...
      Occupation(
        date: DateTime(2026, 1, 7, 10, 00),
        duration: Duration(hours: 2),
        eventName: "GW1300-Entwicklungspsychologie",
        instructor: "Dammermann",
      ),
      Occupation(
        date: DateTime(2026, 1, 7, 12, 00),
        duration: Duration(hours: 2),
  ...
  Room(
    ...
    bookings: [
      ...
      // Dienstag, 06.01.2026
      Occupation(
        date: DateTime(2026, 1, 6, 10, 15),
        duration: Duration(minutes: 105),
        eventName: "Vorlesung Augenheilkunde",
        instructor: "Grisanti",
      ),
      Occupation(
        date: DateTime(2026, 1, 6, 12, 15),
        duration: Duration(minutes: 45),
  ...
  Room(
    ...
    bookings: [
      ...
      // Dienstag, 06.01.2026
      Occupation(
        date: DateTime(2026, 1, 6, 09, 00),
        duration: Duration(hours: 3),
        eventName: "Dr. Haus - vom Symptom zur Diagnose",
        instructor: "Kötter",
      ),
      Occupation(
        date: DateTime(2026, 1, 6, 12, 00),
      ...
      Occupation(
        date: DateTime(2026, 1, 7, 16, 00),
        duration: Duration(hours: 1),
        eventName: "IfG-WS24-TherHaV",
        instructor: "Baumgärtner",
      ),
      Occupation(
        date: DateTime(2026, 1, 7, 18, 00),
        duration: Duration(minutes: 120),
      ...
      Occupation(
        ...
        duration: Duration(minutes: 120),
        eventName:
            "Medizinische Trainingstherapie / PT2510-KP08 / Übung (Gruppe CD)",
        instructor: "Frankenstein",
      ),
      Occupation(
        date: DateTime(2026, 1, 8, 10, 00),
        duration: Duration(hours: 3),
  ...
  Room(
    ...
    bookings: [
      ...
      Occupation(
        date: DateTime(2026, 1, 5, 11, 15),
        duration: Duration(minutes: 45),
        eventName: "Physiologie I",
        instructor: "Kusche",
      ),
      Occupation(
        date: DateTime(2026, 1, 5, 12, 15),
        duration: Duration(minutes: 90),
        eventName: "SWEng V",
        instructor: "Wolter",
      ),
      ...
      Occupation(
        date: DateTime(2026, 1, 7, 12, 00),
        duration: Duration(hours: 4),
        eventName: "Schulung Technischer Betrieb",
        instructor: "Zemke",
      ),
      Occupation(
        date: DateTime(2026, 1, 7, 16, 00),
      ...
      Occupation(
        date: DateTime(2026, 1, 8, 11, 15),
        duration: Duration(minutes: 45),
        eventName: "Physiologie I",
        instructor: "Kusche",
      ),
      Occupation(
        date: DateTime(2026, 1, 8, 12, 15),
        duration: Duration(minutes: 90),
        eventName: "Anatomie",
        instructor: "Kalies",
      ),
      ...
      // Freitag, 09.01.2026
      Occupation(
        date: DateTime(2026, 1, 9, 08, 00),
        duration: Duration(minutes: 120),
        eventName: "Vorlesung Medizinische Psychologie (MedPsy)",
        instructor: "Jessen",
      ),
      Occupation(
        date: DateTime(2026, 1, 9, 11, 15),
        duration: Duration(minutes: 45),
        eventName: "Physiologie I",
        instructor: "Kusche",
      ),
